...
# Create an instance of the Flask class and pass in the __name__ of the current module
app = Flask(__name__)


# Define a route for the root URL ("/") and set strict_slashes=False to allow both with and without trailing slashes
